...
-(id)initWithCoder:(NSCoder *)aDecoder
{
    if(self = [super init])
    {
        ...
        self.achievementsState = [aDecoder decodeObjectForKey:@"achievementsState"];
    }
    return self;
}
-(void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:self.achievementsState forKey:@"achievementsState"];
}
-(id)copyWithZone:(NSZone *)zone
{
    ...
    if(copy)
    {
        ...
        [copy setAchievementsState:[self.achievementsState copyWithZone:zone]];
