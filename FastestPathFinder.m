...
+(NSArray*)findFastestPathWithOccupiedCells:(NSArray *)OccupiedCells withSize:(MSize *)Size withStart:(NSNumber *)start WithEnd:(NSNumber *)end WithCompletionBlock:(FastestPathFinderBlock)block
{
